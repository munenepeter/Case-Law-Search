                ...
                <div class="bg-white rounded-lg shadow-2xl m-4 sm:m-8 w-1/2" x-show="isDialogOpen" @click.away="isDialogOpen = false">
                    <div class="mx-auto p-4 w-full">
                        ...
                        <div class="p-4 bg-gray-50 border rounded-lg  "> 
                            <form action="handle.php" method="post" class="container flex flex-col mx-auto w-full">
                                <div class="mt-2">
                                ...
                                <div class="col-span-full sm:col-span-3 mt-4">
                                    <input type="submit" name="btn" class="bg-blue-500 text-white text-sm font-medium px-6 py-2 rounded capitalize cursor-pointer" value="Upload Case"> 
                                </div>
                            </form>
